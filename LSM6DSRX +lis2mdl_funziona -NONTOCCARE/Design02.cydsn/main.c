...
{   MY_TIMER_Start();                 
   PACER_TIMER_Start();    
    ...
    WriteControlRegisterSPI(LSM6DSRX_CTRL3_C,0x01);
    CyDelay(10);//104 Hz (normal mode)
  ...
  //WriteControlRegisterSPI(LSM6DSRX_CTRL2_G,0x00); //104 Hz (normal mode)
    WriteControlRegisterSPI(LSM6DSRX_CTRL4_C,0x00); //104 Hz (normal mode)
    WriteControlRegisterSPI(0x0B, 0x80); //104 Hz (normal mode)
    WriteControlRegisterSPI(LSM6DSRX_INT1_CTRL,0x01); //104 Hz (normal mode)
    //WriteControlRegisterSPI(LSM6DSRX_INT2_CTRL,0x01); //104 Hz (normal mode)
