...
module top ;
	...
	wire [0:0] tmpOE__bottone_net;
	wire [0:0] tmpIO_0__bottone_net;
	wire [0:0] tmpINTERRUPT_0__bottone_net;
	electrical [0:0] tmpSIOVREF__bottone_net;

	cy_psoc3_pins_v1_10
		#(.id("3cd3c2ea-71a2-4d91-bc3c-a9543e504451"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		bottone
		 (.oe(tmpOE__bottone_net),
		  .y({1'b0}),
		  .fb({Net_470}),
		  .io({tmpIO_0__bottone_net[0:0]}),
		  .siovref(tmpSIOVREF__bottone_net),
		  .interrupt({tmpINTERRUPT_0__bottone_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__bottone_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
