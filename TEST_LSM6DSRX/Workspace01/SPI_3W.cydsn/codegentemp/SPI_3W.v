// ======================================================================
// SPI_3W.v generated from TopDesign.cysch
// 06/22/2023 at 16:26
...
module top ;
    ...
    SPI_Master_v2_50_0 SPI_IMU (
        ...
        .ss(Net_39),
        .tx_interrupt(Net_10));
    defparam SPI_IMU.BidirectMode = 1;
	...
	cy_psoc3_pins_v1_10
		#(.id("d9ffcd73-c1d2-44d2-8ccd-73b7f1595766"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("cc218811-1c45-44ce-bb45-b73631b149dd"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__SDI_SDO_net;
	wire [0:0] tmpFB_0__SDI_SDO_net;
	wire [0:0] tmpINTERRUPT_0__SDI_SDO_net;
	electrical [0:0] tmpSIOVREF__SDI_SDO_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		SDI_SDO
		 (.oe(tmpOE__SDI_SDO_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SDI_SDO_net[0:0]}),
		  .io({Net_37}),
		  .siovref(tmpSIOVREF__SDI_SDO_net),
		  .interrupt({tmpINTERRUPT_0__SDI_SDO_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SDI_SDO_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
